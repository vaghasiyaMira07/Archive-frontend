...
export const setMusicPurchased = async(music) => {
    await localStore.set_MusicPurchased("userinfo", music);
    return true;
};
export const getUserInfo = () => localStore.get_data("userInfo");
export const getMusicData = () => localStore.get_MusicPurchased("userinfo");
